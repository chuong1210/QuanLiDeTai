...
export const NotificationCard = React.forwardRef((props, ref) => {
        ...
        <div className="p-card">
          ...
          <div className="p-header">
            ...
            <div className="p-content">
              <span className="p-title">Đăng ký thành công</span>
              <p className="p-message">Bạn đã vào nhóm ~~~~</p>
            </div>
            <div className="p-actions">
              <Button label="History" className="p-button-success p-history" />
              <Button
