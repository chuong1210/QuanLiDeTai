...
class XLSX {
    static handleImportFile(e: React.ChangeEvent<HTMLInputElement>, callback: (data: any) => void) {
        ...
        if (e.target.files) {
            ...
            reader.onload = (e) => {
                ...
                const workbook = XLSXMain.read(data, { type: "binary", cellDates: true })
    ...
    static handleExportFile(data: any[], fileName: string) {
